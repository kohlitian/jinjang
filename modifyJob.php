			...
			<div class="row">
				<div class="col-sm-6">
					...
					<div class="input-group noSpaceTop">
						...
						<input class="form-control" type="number" name="salary" required id="price" placeholder="Type amount of Salary for job"  value="<?php if (isset($job)) echo $job['hourlyRate']; ?>">
